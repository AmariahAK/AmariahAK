...
I build production AI systems — from agentic orchestration engines to RAG pipelines to native desktop applications. Based in Nairobi, Kenya. Currently focused on making serious AI tooling accessible to developers who don't want cloud lock-in or privacy trade-offs.
...
- Multi-provider: OpenAI · Anthropic · Gemini · Groq · Mistral · xAI · OpenRouter · Ollama · LM Studio
- Compass managed tier (no API key required) — Fast / Balanced / Thinking via OpenRouter
- Full CI/CD via GitHub Actions with Apple Notarisation and Linux packaging (.deb/.rpm/.AppImage)
- Three-tier subscription model (Free / Pro $19/mo / Workforce $79/mo)

**Winner — Amazon Nova AI Hackathon, Devpost × AWS** · Red Bull Basement Global Innovation Programme
...
| **AI / ML** | Agentic Systems · RAG · Graph RAG · Multi-Agent Orchestration · LangChain · Hugging Face · Tree-sitter |
...
**[Praxia](https://github.com/AmariahAK/Praxia_Backend)** — AI healthcare assistant with MONAI X-ray analysis, multilingual symptom diagnosis, real-time WebSocket chat, and Docker/Nginx/Celery production stack.
